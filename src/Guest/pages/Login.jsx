...
import { setToken } from '../../ClientManagement/services/api';
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Note: API_BASE_URL already includes '/guest', so we use '/login' not '/guest/login'
      ...
      >
        <Box sx={{ textAlign: 'center', mb: 4 }}>
          <Avatar sx={{ bgcolor: colors.gold, width: 70, height: 70, mx: 'auto', mb: 2 }}>
            <PersonIcon sx={{ fontSize: 40, color: colors.black }} />
          </Avatar>
        ...
        <Box sx={{ textAlign: 'center', mt: 2 }}>
          <Typography variant="body2" sx={{ color: colors.textSecondary }}>
            ...
            <Link component={RouterLink} to="/register" sx={{ color: colors.gold, textDecoration: 'none', '&:hover': { textDecoration: 'underline' } }}>
              Register here
            </Link>
          </Typography>
        </Box>
